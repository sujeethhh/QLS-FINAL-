          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            >
              ...
              <motion.h2
                ...
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                <span className="relative z-10">Knowledge Areas</span>
                <motion.div
            ...
            >
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-xs text-slate-600 font-medium">Lead. Deliver. Excel.</div>
                </div>
              </motion.div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive range of Project Management courses
            </p>
          </motion.div>
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 p-4">
                    <span className="bg-green-600 text-white text-xs font-semibold px-3 py-1 rounded-full">PMI</span>
