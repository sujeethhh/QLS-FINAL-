        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            >
              ...
              >
                <div className="text-center">
                  <div className="text-2xl font-bold font-serif text-slate-800">PSK I</div>
                  <div className="text-xs text-slate-600 font-medium">Flow. Measure. Improve.</div>
                </div>
              </motion.div>
            </motion.div>
          </div>
